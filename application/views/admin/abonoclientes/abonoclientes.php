            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                  ...
                  <div class="row">
                    <div class="box-header with-border">
                      <div class="col-md-offset-5 col-md-10">
                        <h1 class="box-title"><dt>Abonos registrados de clientes</dt></h1>
                      </div>
                    </div>
                  </div>
                </div><!-- /.with-border -->
                ...
                <table class="table table-responsive table-striped table-bordered table-hover table-condensed">
                                    ...
                                    if(isset($abono)){
                                    foreach ($abono as $ac){
                                        echo    "<tr><td>" . $ac->notacobrar . "</td>" . 
                                                "<td class='hidden-xs hidden-sm hidden-md'>" . $ac->fechaabono . "</td>" .
                                                "<td>" . $ac->cantidadabono . "</td>";
                                                /*
                                                ...
                                                */
                                                ...
                                                echo "<td class='hidden-xs hidden-sm'><a href='../Abonoclientes/actualizarabonoclientes/$ac->idabonoclientes'>Modificar</a></td>".
                                                        "<td class='hidden-md hidden-lg'><a href='../Abonoclientes/actualizarabonoclientes/$ac->idabonoclientes'><img src='<?php echo base_url();?>images/act.png'></a></td>".
                                                    "<td class='hidden-xs hidden-sm'><a href='../Abonoclientes/delAbonocliente/$ac->idabonoclientes'>Eliminar</a></td>".
                                                        "<td class='hidden-md hidden-lg'><a href='../Abonoclientes/delAbonocliente/$ac->idabonoclientes'><img src='<?php echo base_url();?>images/act.png'></a></td>";
