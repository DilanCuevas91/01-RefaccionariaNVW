            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <table class="table table-responsive table-striped table-bordered table-hover table-condensed">
                                        <tr>
                                            <td colspan="5"><a href="agregarproveedores"><button type='button' class='btn btn-primary btn-xs'>Agregar nuevo proveedor</button></a></td>
                                        </tr>
                                        <tr style="color:blue;">
                                    ...
                                    if(isset($provee)){
                                    foreach ($provee as $p){
                                        echo    "<tr><td>" . $p->nombreproveedor . "</td>" .
