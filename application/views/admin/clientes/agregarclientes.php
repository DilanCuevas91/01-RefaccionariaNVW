                  ...
                  <div class="row">
                    <div class="box-header with-border">
                      <div class="col-md-offset-5 col-md-10">
                        <h1 class="box-title"><dt>Agregar cliente</dt></h1>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <?php echo form_open('Clientes/addCliente');?>
                  <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <?php echo form_error('emailcliente'); ?>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          ...
                          <div class="form-group">
                            ...
                            <select class="" name="direccion" required>

                              <option value="" selected="selected">Seleccione la dirección</option>
                               <?php
                                       if(isset($direc)){
                                          foreach ($direc as $p){
                            ...
                            <?php echo form_error('iddireccion'); ?>
